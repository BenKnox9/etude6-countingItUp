...
/**
 * Class used to run testing on our CountingItUp program. Spits out the corresponding times and values into our csv file
 */
public class CoutingItUpTesting {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileWriter fileOutput = new FileWriter("/Users/danielbohinc/Documents/2023/COSC326/etude6-countingitup/testOutput.csv");
        ...
        for(int i = 0; i <= 9; i++) {
            ...
            fileOutput = new FileWriter("/Users/danielbohinc/Documents/2023/COSC326/etude6-countingitup/testOutput.csv");
        }
